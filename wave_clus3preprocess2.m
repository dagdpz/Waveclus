...
% handles.rawname = 'Moe_Recording*.sev';
...
% handles.dtype = 'int16';                                                  % Default for BR, TD
...
% ARRAY CONFIGURATION
handles.numArray = 1;    
handles.numchan = 128;                                                       % Channels per Array
...
handles.par.transform_factor = 1;                                           % Default for RHD2000
handles.par.transform_factor = 0.195;                                           % Default for RHD2000
