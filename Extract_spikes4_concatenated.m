function Extract_spikes4_concatenated(handles)
...
switch handles.threshold
    case 'pos'
        save([handles.WC_concatenation_folder 'dataspikes_ch' sprintf('%03d',handles.current_channel) '_' num2str(handles.current_channel_file) '_onethr'],'spikes','index','thr','par','cluster_class')
    case 'neg'
        save([handles.WC_concatenation_folder 'dataspikes_ch' sprintf('%03d',handles.current_channel) '_' num2str(handles.current_channel_file) '_onethr'],'spikes','index','thr','par','cluster_class')
    case 'both'
        ...
        save([handles.WC_concatenation_folder 'dataspikes_ch' sprintf('%03d',handles.current_channel) '_' num2str(handles.current_channel_file) '_negthr'],'spikes','index','thr','par','cluster_class')
        spikes = spikesall(spikesign == 1,:);
        index = indexall(spikesign == 1);
        save([handles.WC_concatenation_folder 'dataspikes_ch' sprintf('%03d',handles.current_channel) '_' num2str(handles.current_channel_file) '_posthr'],'spikes','index','thr','par','cluster_class')
end
