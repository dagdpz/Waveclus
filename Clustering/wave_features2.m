function [inspk,feature_names,spikesadd,spikecomp] = wave_features2(spikes,handles)
...
%         clear peakindfirst firstamp 
        ...
        %real spikes
        for i=1:len/downfac, fn{len+i}=sprintf('S,%d',i);
        end
        
        %pca features
        for i=1:3, fn{len+len/downfac+i}=sprintf('PCA,%d',i);
        end
%         %peaktopeak
