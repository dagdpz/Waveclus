...
handles.par.selectionmeth = 'eu';           %eu: eucleadiean; corr: correlation; lilli: lillifors  
handles.par.exclusioncrit = 'thr';          % thr; number 
handles.par.exclusionthr = 1.4;               %def for Euclidean = 1; for corr = 0.85  ; for lilli = 0.05;
...
for k =  1 : length(channels),
    ...
    [features,feature_names,inputs] = wave_features5(spikes,handles);
