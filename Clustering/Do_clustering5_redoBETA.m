function Do_clustering5_redo(handles)
...
handles.par.exclusionthr = 0.97;               %def explained variance of 99% = 0.99
handles.par.maxinputs = 12;   %17, 15              %number of inputs to the clustering def. 11
...
for k =  1 : length(channels)
    ...
    [features,feature_names,inputs] = wave_features6(spikes,handles);
