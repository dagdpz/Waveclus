function Do_clustering4_redo_concatenated(handles)
handles.bname='V1';
ifplot=1;
...
for k =  1 : numel(thresholds)
    ...
    filename=['dataspikes_ch' channelfile thresholds{k} '.mat'];
    ...
    handles.fname = ['data_' channelfile thresholds{k}];   %filename for interaction with SPC
...
%      print(handles.htimecourse,['timecourse' '-' filename],'-djpeg');
%     close (handles.htimecourse)
        ...
        if print2file==0;
            ...
            print(current_figure_handle,[handles.bname '-' channelfile thresholds{k}],'-djpeg');
