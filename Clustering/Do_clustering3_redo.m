function Do_clustering3_redo(handles)
...
handles.par.exclusionmeth = 'euclidean';     % corr; euclidean; none
handles.par.exclusioncrit = 1;              %def for Euclidean = 1; for corr = 0.85
% handles.par.inputs = 13;   %17            %number of inputs to the clustering def. 11
handles.par.criticalvaluerejection = 1;
handles.par.maxinputs = 17;
...
for k =  1 : length(channels),
    ...
    [features,feature_names,inputs] = wave_features4(spikes,handles);
