function SpikefilterChan8B(handles)
...
for i = 1 : length(files)
    ...
    switch handles.sys
        case 'TD'
            ...
            data = fread(channel_file_handle, no_samples, [dtype '=>' dtype]);             %reads out the data, int16 - class of input and output values
        ...
        case 'BR'
            load(files{i});
            data = single(data)*transform_factor;
    ...
    if strcmp(handles.hp,'med')
        data = double(data);
        xx = median_filter(double(data),n);
