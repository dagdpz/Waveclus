...
%      print(handles.htimecourse,['timecourse' '-' channel],'-djpeg');
%     close (handles.htimecourse)
        
        %% plotting WC main fiugre
        ...
        ylim([mn mx]);
        title(sprintf('%s-%s',handles.bname,channel),'Fontsize',12,'interpreter','none')
        ...
        if print2file==0;
            ...
            print(current_figure_handle,[handles.bname '-' channel],'-djpeg');
