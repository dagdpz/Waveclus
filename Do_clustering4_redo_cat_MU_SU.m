...
% handles.WC.exclusioncrit = 'thr';          % thr; number
% handles.WC.exclusionthr = 0.8;               %def R^2 = 0.80
...
for k =  1 : numel(thresholds)
    ...
    disp([' clustering ' handles.WC_concatenation_folder filename ' took ' round(num2str(toc)) ' seconds']);        
end
clear handles
